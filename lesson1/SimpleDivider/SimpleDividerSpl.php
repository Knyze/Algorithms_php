...
class SimpleDividerSpl
{
    ...
    public function __construct($number)
    {
        ...
        $this->currentSimpleNumbers =new SplQueue();
        //$obj = new ArrayObject($this->currentSimpleNumbers);
        //$this->iter = $obj->getIterator();
        $this->run();
    }
    ...
    private function isSimpleNumber($number)
    {
        ...
        $this->currentSimpleNumbers->enqueue($number);
        return true;
    }
